...
export const productStackContract = Object.freeze({
  ...
  ecommerce: stack({
    databaseScopes: ["platform-master", "tenant-core", "tenant-ecommerce", "tenant-billing"],
    formula: ["framework", "platform", "core", "billing-contracts", "ecommerce"],
    foundationServices: [],
    ownedDatabaseScopes: ["tenant-ecommerce"],
    productServices: ["platform-api", "platform-web"],
