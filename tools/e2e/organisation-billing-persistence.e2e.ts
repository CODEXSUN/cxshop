...
import { createApiApp } from "@cxshop/framework/api";
import {
  runWithBillingScope,
  withBillingScope
...
const databaseName = `cxshop_persistence_e2e_${runId}`;
const isolatedDatabaseName = `cxshop_persistence_isolated_e2e_${runId}`;
