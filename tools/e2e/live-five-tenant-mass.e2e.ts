...
const tenantDefinitions = [
  { code: "CODEXSUN", databaseName: "cxshop_db", name: "Codexsun" },
  { code: "LOAD01", databaseName: "cxshop_load_01", name: "Load Tenant 01" },
  { code: "LOAD02", databaseName: "cxshop_load_02", name: "Load Tenant 02" },
  { code: "LOAD03", databaseName: "cxshop_load_03", name: "Load Tenant 03" },
  { code: "LOAD04", databaseName: "cxshop_load_04", name: "Load Tenant 04" }
] as const;
