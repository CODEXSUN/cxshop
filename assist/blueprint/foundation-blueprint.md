...
```text
API client package: @cxshop/api-client
```
...
- `@cxshop/api-client` should not own business rules.
...
`@cxshop/ui` should provide shared UI primitives, business components, layout components, form components, table components, app shell elements, feedback components, and design tokens.
...
@cxshop/ui/tokens
@cxshop/ui/theme
@cxshop/ui/primitives
@cxshop/ui/forms
@cxshop/ui/tables
@cxshop/ui/layouts
@cxshop/ui/navigation
@cxshop/ui/feedback
@cxshop/ui/overlays
@cxshop/ui/business
```

Platform can still own platform-specific screens and logic, but reusable visual components belong in `@cxshop/ui`.
...
```text
@cxshop/framework/api
@cxshop/framework/config
@cxshop/framework/db
@cxshop/framework/logger
@cxshop/framework/errors
@cxshop/framework/modules
@cxshop/framework/events
@cxshop/framework/queue
@cxshop/framework/http
@cxshop/framework/env
```
...
```text
@cxshop/core/company
@cxshop/core/contacts
@cxshop/core/products
@cxshop/core/address
@cxshop/core/location
@cxshop/core/files
@cxshop/core/tags
@cxshop/core/notes
```
