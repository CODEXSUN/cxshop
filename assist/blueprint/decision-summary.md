...
UI system lives in `@cxshop/ui`.

`@cxshop/ui` uses Tailwind CSS, shadcn/ui style patterns, and Mantine-inspired styling/ergonomics while remaining CODEXSUN's own UI framework.
