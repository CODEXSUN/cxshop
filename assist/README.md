...
The canonical local project repository is `E:\Workspace\codexsun\cxshop`.
Use it as the root for planning, implementation, verification, and release
work. Older CODEXSUN/CXSUN checkouts outside `E:\Workspace\codexsun\cxshop` are not
project references.
...
rhythm into CODEXSUN through `@cxshop/ui`; do not paste unrelated business logic or old module boundaries blindly.
