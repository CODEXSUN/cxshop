...
- Categories, collections, attributes, variants, and media.
- Vendors, memberships, offers, inventory, and service areas.
- Carts, checkout, marketplace orders, and seller orders.
- Fulfillment, returns, refunds, disputes, and reviews.
- Promotions, commissions, settlements, and payouts.

Core owns the canonical product identity. Billing owns financial documents and tax posting.
