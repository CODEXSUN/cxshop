...
Ecommerce is a separate CXShop application for multi-vendor B2C and B2B commerce.

It owns catalog publication, vendor offers, inventory reservations, carts, checkout, seller order splitting, fulfillment, returns, reviews, commissions, and settlements.

It extends Core Products through Ecommerce Product Information. It uses Billing through public financial contracts.
