...
- Working repository: `E:\Workspace\codexsun\cxshop`
...
- Use shared design-system and workspace components from `@cxshop/ui`.
...
- Use `WorkspaceSelect` or the shadcn/Radix themed `Select` from `@cxshop/ui`.
