...
If a package needs public subpath compatibility such as `@cxshop/billing/api` or `@cxshop/billing/migrations`, expose those package exports from the module index instead of recreating top-level source folders.
