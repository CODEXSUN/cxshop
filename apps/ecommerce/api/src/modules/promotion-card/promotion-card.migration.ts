...
export const promotionCardMigration = {
  description: "Store Ecommerce promotion card documents and their Frappe source identity.",
  key: "ecommerce.storefront.promotion-document"
} as const;

export async function migratePromotionCardModule(database: Kysely<EcommerceDatabase>) {
  await sql
    .raw(
