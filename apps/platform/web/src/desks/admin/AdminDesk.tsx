...
import { AdminLayout, Button, Card, GlobalLoader, StatusBadge } from "@cxshop/ui";
import { AuthGate } from "../../shared/auth/AuthGate";
import { apiGet, logout } from "../../shared/api/platform-api";
import type { PlatformAppDefinition } from "../../app/app-registry";

type AdminPage = "dashboard" | "app-registry" | "application-setup" | "activation";
    ...
    <AuthGate desk="admin">
      <AdminLayout
        ...
        actions={
          <div className="flex flex-wrap justify-end gap-2">
            ...
            <Button
              size="sm"
              variant={page === "application-setup" ? "default" : "ghost"}
              onClick={() => setPage("application-setup")}
            >
              Application Setup
            </Button>
            <Button
      ...
      >
        <main className="mx-auto w-[calc(100%-2rem)] max-w-[92rem] space-y-4 py-5 lg:w-[calc(100%-3rem)]">
          {page === "dashboard" ? (
            <div className="grid gap-4 md:grid-cols-3">
              <AdminCard
                ...
                icon={Building2Icon}
                text="Review the standalone database and application runtime."
              />
              <AdminCard
                title="App Registry"
          ...
          {page === "application-setup" ? (
            <Card title="Application Setup" description="Standalone application operations.">
