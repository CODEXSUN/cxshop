...
import { ApplicationLayout } from "@cxshop/ui/layouts/application-layout";
...
import {
  getDefaultCompany,
  saveDefaultCompany
} from "@cxshop/core-web/modules/organisation/default-company/services";
import type { LandingAppOption } from "@cxshop/core-web/modules/organisation/default-company/types";
import { listFinancialYears } from "@cxshop/core-web/modules/organisation/financial-year/services";
...
const loadBillingDashboardModule = () => import("@cxshop/billing-web/modules/dashboard");
const loadQuotationModule = () => import("@cxshop/billing-web/modules/quotation");
const loadSalesModule = () => import("@cxshop/billing-web/modules/sales");
const loadPurchaseModule = () => import("@cxshop/billing-web/modules/purchase");
const loadExportSalesModule = () => import("@cxshop/billing-web/modules/export-sales");
const loadPaymentModule = () => import("@cxshop/billing-web/modules/payment");
const loadReceiptModule = () => import("@cxshop/billing-web/modules/receipt");
const loadBillingReportsModule = () => import("@cxshop/billing-web/modules/reports");
const loadEcommerceOverviewModule = () => import("@cxshop/ecommerce-web/modules/catalog-overview");
const loadProductInformationModule = () =>
...
const EcommerceOverviewWorkspace = lazyWorkspace(() =>
  loadEcommerceOverviewModule().then((module) => module.CatalogOverviewWorkspace)
);
const ProductInformationWorkspace = lazyWorkspace(() =>
  loadProductInformationModule().then((module) => module.ProductInformationWorkspace)
);
const ProductVariantWorkspace = lazyWorkspace(() =>
  loadProductVariantModule().then((module) => module.ProductVariantWorkspace)
);
...
const BankNamesWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/contacts/bank-names").then(
    (module) => module.BankNamesWorkspace
  )
);
const ContactGroupsWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/contacts/contact-groups").then(
    (module) => module.ContactGroupsWorkspace
  )
);
const ContactTypesWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/contacts/contact-types").then(
    (module) => module.ContactTypesWorkspace
  )
);
const CityWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/location/city").then((module) => module.CityWorkspace)
);
const CountryWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/location/country").then(
    (module) => module.CountryWorkspace
  )
);
const DistrictWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/location/district").then(
    (module) => module.DistrictWorkspace
  )
);
const PincodeWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/location/pincode").then(
    (module) => module.PincodeWorkspace
  )
);
const StateWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/location/state").then((module) => module.StateWorkspace)
);
const LedgerGroupsWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/accounts/ledger-groups").then(
    (module) => module.LedgerGroupsWorkspace
  )
);
const LedgersWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/accounts/ledgers").then(
    (module) => module.LedgersWorkspace
  )
);
const CurrenciesWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/others/currencies").then(
    (module) => module.CurrenciesWorkspace
  )
);
const MonthsWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/others/months").then((module) => module.MonthsWorkspace)
);
const PaymentTermsWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/others/payment-terms").then(
    (module) => module.PaymentTermsWorkspace
  )
);
const PrioritiesWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/others/priorities").then(
    (module) => module.PrioritiesWorkspace
  )
);
const SalesTypesWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/others/sales-types").then(
    (module) => module.SalesTypesWorkspace
  )
);
const BrandsWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/products/brands").then((module) => module.BrandsWorkspace)
);
const ColoursWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/products/colours").then(
    (module) => module.ColoursWorkspace
  )
);
const HsnCodesWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/products/hsn-codes").then(
    (module) => module.HsnCodesWorkspace
  )
);
const ProductCategoriesWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/products/product-categories").then(
    (module) => module.ProductCategoriesWorkspace
  )
);
const ProductGroupsWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/products/product-groups").then(
    (module) => module.ProductGroupsWorkspace
  )
);
const ProductTypesWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/products/product-types").then(
    (module) => module.ProductTypesWorkspace
  )
);
const SizesWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/products/sizes").then((module) => module.SizesWorkspace)
);
const StylesWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/products/styles").then((module) => module.StylesWorkspace)
);
const TaxesWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/products/taxes").then((module) => module.TaxesWorkspace)
);
const UnitsWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/products/units").then((module) => module.UnitsWorkspace)
);
const DestinationsWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/workorder/destinations").then(
    (module) => module.DestinationsWorkspace
  )
);
const StockRejectionTypesWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/workorder/stock-rejection-types").then(
    (module) => module.StockRejectionTypesWorkspace
  )
);
const TransportsWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/workorder/transports").then(
    (module) => module.TransportsWorkspace
  )
);
const WarehousesWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/workorder/warehouses").then(
    (module) => module.WarehousesWorkspace
  )
);
const WorkOrderTypesWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/common/workorder/work-order-types").then(
    (module) => module.WorkOrderTypesWorkspace
  )
);
const ContactWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/master/contact").then((module) => module.ContactWorkspace)
);
const ProductWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/master/product").then((module) => module.ProductWorkspace)
);
const WorkOrderWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/master/work-order").then((module) => module.WorkOrderWorkspace)
);
const CompanyWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/organisation/company").then((module) => module.CompanyWorkspace)
);
const DefaultCompanyWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/organisation/default-company").then(
    (module) => module.DefaultCompanyWorkspace
  )
);
const FinancialYearWorkspace = lazyWorkspace(() =>
  import("@cxshop/core-web/modules/organisation/financial-year").then(
...
const BillingSettingsWorkspace = lazyWorkspace(() =>
  import("@cxshop/billing-web").then((module) => module.BillingSettingsWorkspace)
);
const DocumentSettingsWorkspace = lazyWorkspace(() =>
  import("@cxshop/billing-web").then((module) => module.DocumentSettingsWorkspace)
);
...
const MailWorkspace = lazyWorkspace(() =>
  import("@cxshop/mail-web/modules/mail").then((module) => module.MailWorkspace)
);
...
export function AppDesk() {
  ...
  const companiesQuery = useQuery({
    enabled: Boolean(setupQuery.data?.application.uuid),
    queryFn: () => listCompanies(),
    queryKey: ["core", "organisation", "companies", setupQuery.data?.application.uuid],
    staleTime: 5 * 60 * 1_000
  });
  const financialYearsQuery = useQuery({
    enabled: Boolean(setupQuery.data?.application.uuid),
    queryFn: listFinancialYears,
    queryKey: ["core", "organisation", "financial-years", setupQuery.data?.application.uuid],
    staleTime: 5 * 60 * 1_000
  });
  const defaultCompanyQuery = useQuery({
    enabled: Boolean(setupQuery.data?.application.uuid),
    queryFn: getDefaultCompany,
    queryKey: [...defaultCompanyQueryKey, setupQuery.data?.application.uuid],
    staleTime: 5 * 60 * 1_000
  });
  ...
  const moduleKeys = setup?.application.enabledModuleKeys ?? ["platform.application"];
  ...
  const billingSettingsQuery = useQuery({
    ...
    queryFn: async () => {
      const module = await import("@cxshop/billing-web/modules/settings/services");
  ...
  useEffect(() => {
    if (activeApp !== "ecommerce") return;
    const timeoutId = setTimeout(() => {
      void Promise.allSettled([loadEcommerceOverviewModule(), loadProductInformationModule()]);
    }, 500);
    return () => clearTimeout(timeoutId);
  }, [activeApp]);
  ...
  useEffect(() => {
    ...
    if (setupQuery.isLoading || !defaultCompanyQuery.isFetched) return;
  ...
  const contextError =
    !defaultCompanyQuery.isLoading && setup?.application && !activeDefaultCompany
      ? new Error("Configure an active Default Company before opening the tenant workspace.")
      : !companiesQuery.isLoading && setup?.application && !selectedCompany
        ? new Error("No active company is available for this application.")
        : !financialYearsQuery.isLoading && setup?.application && !selectedFinancialYear
          ? new Error("No active financial year is available for this application.")
          : null;
...
function pageFromUrl(landingApp: PlatformAppId | null): AppPage {
  ...
  if (
    ...
    key === "ecommerce.catalog.categories" ||
    key === "ecommerce.catalog.brands" ||
    key === "ecommerce.catalog.products" ||
  ...
  const choices = enabledApps.map((appId) => ({
    description:
      appId === "billing"
        ...
        : appId === "ecommerce"
          ? "Catalog content, publication, vendor offers, and marketplace operations."
          : appId === "mail"
