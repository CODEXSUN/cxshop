  ...
  return (
    <TenantSiteTemplate activePage="cookies" pageTitle="Cookie policy">
      <TenantPageIntro
        ...
        summary="CXShop uses essential cookies for authentication, security, preferences, and service continuity. Optional analytics should only run when consent is available."
      />
